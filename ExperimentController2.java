 ...
 * Name: Angelica Gu
 * Date: Jun 13 2025
 * Class: ExperimentController2
 * Description: Controller for ExperimentFrame2. Handles buttons, dragging
 * placing and check the three circuits every time a new action is detected.
 */
...
public class ExperimentController2 implements ActionListener {

	// create the view
	private ExperimentFrame2 frame;

	// set a variable to store the situation of the circuit
	// 1=open circuit, 2=short circuit, 3=valid, 4=missing battery
	private int[] pathSituations = new int[3];
	...
	// constructor
	public ExperimentController2() {

		// view
		frame = new ExperimentFrame2();
	...
	private void updateAllPathSituations() {
		...
		// set the three paths
		int[][] paths = { { 0, 1, 5, 4 }, { 0, 2, 6, 4 }, { 0, 3, 7, 4 } };
	...
	private void lightUpPathIfValid() {
		...
		// 2D array to store the three pathes
		int[][] paths = { { 0, 1, 5, 4 }, { 0, 2, 6, 4 }, { 0, 3, 7, 4 } };
