 ...
 * Name: Angelica Gu
 * Date: Jun 13 2025
 * Class: EducationFrame2
 * Description: This is the second page of education: Parallel Circuit.
 * It can lead to the experiment frame of parallel circuit.
 */
...
public class EducationFrame2 extends JFrame {
	...
	public JLabel titleLabel2 = new JLabel("2, Parallel Circuits");
	public JLabel contentLabel = new JLabel("<html>In a parallel circuit, components are connected"
			+ "<br> across the same voltage source, creating" + "<br> multiple paths for current. If one component"
			+ "<br> fails, others can still operate. Home lighting"
			+ "<br> systems are mostly parallel circuits</html>");
	public JButton experimentButton = new JButton("Build One Yourself");
	public ImageIcon seriesCircuit = new ImageIcon("src/images/Parallel.png");
	public JLabel gifLabel = new JLabel(seriesCircuit);
	public JLabel noteLabel = new JLabel("Every bulb is independent.");
	public JButton lastButton = new JButton("← Last");
	public JButton nextButton = new JButton("Next →");

	// the frame
	public EducationFrame2() {
	...
	private void frameSetup() {
		...
		noteLabel.setBounds(741, 418, 354, 32);
