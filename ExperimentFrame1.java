 ...
 * Name: Angelica Gu
 * Date: Jun 13 2025
 * Class: ExpermientFrame1
 * Description:  This is the series circuit experiment.
...
public class ExperimentFrame1 extends JFrame {
	...
	public class PaintPanel extends JPanel {
		...
		public PaintPanel() {
			...
			backgroundImage = new ImageIcon("src/images/background1.png").getImage();

			// set the position for the slots
			componentSlots.add(new GridCell(100, 140));
			componentSlots.add(new GridCell(245, 40));
			componentSlots.add(new GridCell(390, 40));
			componentSlots.add(new GridCell(535, 40));
			componentSlots.add(new GridCell(680, 140));
			componentSlots.add(new GridCell(535, 240));
			componentSlots.add(new GridCell(390, 240));
			componentSlots.add(new GridCell(245, 240));
		}
		...
		protected void paintComponent(Graphics g) {
			...
			if (backgroundImage != null) {
				g.drawImage(backgroundImage, 95, 30, 600, 220, this);
			}

			// Draw the grids
			for (GridCell cell : componentSlots) {
				g.setColor(Color.LIGHT_GRAY);
				g.fillRect(cell.getRow() - 54, cell.getCol() - 30, 109, 61);
